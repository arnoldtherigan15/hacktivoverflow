                ...
                <div class="ques-content">
                    ...
                    <div style="display:flex;">
                        <div style="width:85%; display:flex; flex-wrap:wrap;">
                            <div @click.prevent="filterloopTag(tag)" v-for="(tag,index) in question.tags" :key="index" class="py-2 mr-2 my-1" style="text-align:center; width:15%; background-color:#e1ecf4; cursor:pointer;">
                              {{tag}}
                            </div>
                        </div>
