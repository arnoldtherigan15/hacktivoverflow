<template>
    <div class="container allQues" style="height:100vh;">
        <h2 style="color:white;">All Question</h2>
        <h2 style="margin-bottom: 50px;">My Question</h2>
        <div class="question" v-for="(question,index) in myQuestion.slice().reverse()" :key="index">
            <div class="ques-item">
               <div class="vote-sesction mx-5">
                ...
                <div class="ques-content">
                    ...
                    <div v-html="question.description" class="text-break">
